...
import 'package:test_design/ui/administrate/brands/add_edit_brand/add_edit_brand_controller.dart';

class AddEditBrandPage extends ConsumerWidget {
  const AddEditBrandPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(addEditBrandController);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: StrokeText(
          text: controller.editing ? "Editar Marca": "Añadir Marca",
