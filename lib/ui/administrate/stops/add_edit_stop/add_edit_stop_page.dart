              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      focusNode: controller.stopFocusNode,
                      onChanged: (value) {
                      ...
                      decoration: InputDecoration(
                        error: (controller.stopIsBad() && controller.stopTouched) ? Padding(
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).pushNamed('/stop_map', arguments: {
                          "stop": controller.coordinateController.text
                        }).then((result) {
                          if(result != null) {
